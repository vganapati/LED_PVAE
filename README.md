...
python SyntheticMNIST_multislice.py --save_path foam_v2_pac1 --td --tn_train 15000 --tn_test 10 --rad 3 --Nx 128 --Ny 128 --dti 5 --rmf 0.9 -f 0 --ns 1 --pac 1
...
P-VAE training runs:
./sweep.sh dataset_foam_v2_pac1 foam_pac1
./sweep_single_example.sh dataset_foam_v2_pac1 foam_pac1
./optimizer_sweep.sh dataset_foam_v2_pac1 10000 5 1e-3


create_multiplexed.py
--input_path dataset_MNIST_multislice_v2 --save_tag pnm2e4_dm01_p3 --pnm 26869.35 --dm 0.1 -p 3
--input_path dataset_MNIST_multislice_v2 --save_tag pnm2e4_dm01_p1 --pnm 26869.35 --dm 0.1 -p 1

bsub -oo output103 -J job3 -n 8 -gpu "num=1" -q gpu_any python create_multiplexed.py --input_path dataset_MNIST_multislice_v2 --save_tag pnm2e4_dm01_p3 --pnm 26869.35 --dm 0.1 -p 3

bsub -oo output103 -J job3 -n 8 -gpu "num=1" -q gpu_any python create_multiplexed.py --input_path dataset_MNIST_multislice_v2 --save_tag pnm2e4_dm01_p1 --pnm 26869.35 --dm 0.1 -p 1



first noise level: 
bsub -oo output103 -J job3 -n 8 -gpu "num=1" -q gpu_any python create_multiplexed.py --input_path dataset_MNIST_multislice_v2 --save_tag pnm1e2_dm01_p4 --pnm 1e2 --dm 0.1 -p 4

DONE
other noise levels:
bsub -oo output104 -J job3 -n 8 -gpu "num=1" -q gpu_any python create_multiplexed.py --input_path dataset_MNIST_multislice_v2 --save_tag pnm1e3_dm01_p4 --pnm 1e3 --dm 0.1 -p 4 --save_tag_alpha pnm1e2_dm01_p4

bsub -oo output105 -J job3 -n 8 -gpu "num=1" -q gpu_any python create_multiplexed.py --input_path dataset_MNIST_multislice_v2 --save_tag pnm1e4_dm01_p4 --pnm 1e4 --dm 0.1 -p 4 --save_tag_alpha pnm1e2_dm01_p4

bsub -oo output106 -J job3 -n 8 -gpu "num=1" -q gpu_any python create_multiplexed.py --input_path dataset_MNIST_multislice_v2 --save_tag pnm1e5_dm01_p4 --pnm 1e5 --dm 0.1 -p 4 --save_tag_alpha pnm1e2_dm01_p4

./optimizer_sweep.sh dataset_MNIST_multislice_v2 4000

./sweep_single_example.sh dataset_MNIST_multislice_v2 mnist 0

./optimizer_sweep.sh dataset_MNIST_multislice_v2 10000 5 1e-3
...
bsub -oo output_uniform -J job3 -n 4 -gpu "num=1" -q gpu_any python create_multiplexed.py --input_path dataset_MNIST_multislice_v2 --save_tag pnm1e4_uniform_p4 --pnm 1e4 --dm 0.1 -p 4 --uniform
...
Pipeline:
SyntheticMNIST_multislice.py OR load_data.py (latter for real data)
create_multiplexed.py
